        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div v-if="form.type === 'transfer'" class="space-y-2">
                ...
                <Select v-model="form.to_account_id" required>
                    ...
                    <SelectContent>
                        <SelectItem v-for="account in filteredToAccounts" :key="account.id"
        ...
        <div class="space-y-4">
            <div class="space-y-2">
                ...
                <Input id="title" v-model="form.title"
                    placeholder="e.g., Monthly salary, Grocery shopping, ATM withdrawal" />
            </div>

            <div class="space-y-2">
                <Label for="description">Description</Label>
                <Textarea id="description" v-model="form.description"
                    placeholder="Additional details about this transaction" rows="3" />
            </div>
